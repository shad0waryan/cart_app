  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <ol className="grid grid-cols-2 justify-center">
          <li>
            <div className="flex m-2 ">
              <div className="block p-6 rounded-lg shadow-lg  bg-white ">
                ...
                {/* itemCode, qty, price, name, discount */}
                <button
                  onClick={() => {
                    addToCart(96, 1, 30, "lighting ceiling kitchen", 14.89);
                  }}
                  type="button"
                  className=" inline-block px-3 py-2 bg-blue-500 text-white font-medium text-sm leading-tight rounded shadow-md hover:bg-blue-800 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Add to cart
                </button>
              </div>
